...
from src.pipeline.exception import CustmeException
...
if __name__ =="__main__":
    print('start')
    obj = DataIngestion()
    traindp, testdp = obj.inititate_data_ingestion()

    data_transformation = DataTransformation()
    train_arr, test_arr, _ = data_transformation.inititate_data_transformation(traindp , testdp)
    print('complete')
